...
$hero_bg = 'images/background/bg-page-title-1.webp';
...
<section class="relative pt-24 pb-28 overflow-hidden">
  <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('images/background/contact-bg-ov.webp')"></div>
